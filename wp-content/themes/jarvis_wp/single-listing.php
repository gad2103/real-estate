                 ...
                 <div class="project-info">                    
                    ...
                    <div class="project-details">
                        <h3><span><?php echo $smof_data['rnr_portfolio_details_title']; ?></span></h3>
                                                            <?php if( get_post_meta( get_the_ID(), 'rnr_price', true ) != "") { ?>
                                <p><strong><i class="icon-usd"></i>:</strong> <?php echo get_post_meta( get_the_ID(), 'rnr_price', true ); ?></p>
                                <?php } ?>	
                                <?php if( get_post_meta( get_the_ID(), 'rnr_beds', true ) != "") { ?>
                                    <p><strong>Bedrooms:</strong> <?php echo get_post_meta( get_the_ID(), 'rnr_beds', true ); ?></p>
                                <?php } ?>	
                                <?php if( get_post_meta( get_the_ID(), 'rnr_baths', true ) != "") { ?>
                                    <p><strong>Bathrooms:</strong> <?php echo get_post_meta( get_the_ID(), 'rnr_baths', true ); ?></p>
                                <?php } ?>	
                                <?php if( get_post_meta( get_the_ID(), 'rnr_sqft', true ) != "") { ?>
                                    <p><strong>Square Feet:</strong> <?php echo get_post_meta( get_the_ID(), 'rnr_sqft', true ); ?></p>
                                <?php } ?>	
                                <?php if( get_post_meta( get_the_ID(), 'rnr_lotsize', true ) != "") { ?>
                                    <p><strong>Lot Size:</strong> <?php echo get_post_meta( get_the_ID(), 'rnr_lotsize', true ); ?></p>
                                <?php } ?>	
                                <?php if( get_post_meta( get_the_ID(), 'rnr_zip', true ) != "") { ?>
                                    <p><strong>Zip Code:</strong> <?php echo get_post_meta( get_the_ID(), 'rnr_zip', true ); ?></p>
                                <?php } ?>	
                                <?php if( get_post_meta( get_the_ID(), 'rnr_mls', true ) != "") { ?>
                                    <p><strong>MLS #:</strong> <?php echo get_post_meta( get_the_ID(), 'rnr_mls', true ); ?></p>
                                <?php } ?>	

                                <p><strong><?php _e('Status: ', 'rocknrolla'); ?></strong> <?php $taxonomy = strip_tags( get_the_term_list($post->ID, 'listings_filter', '', ', ', '') ); echo $taxonomy; ?></p>
